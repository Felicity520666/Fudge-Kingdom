...
transform smallright:
    zoom 0.7  # scale down to 70% of original size
...
label start:
    ...
    o "I'm not crazy?! I'm talking to fudges!"
    ...
    a "Well, you see, this is the fudge kingdom. Everyone here is a fudge."
    o "HEY! Excuse me?! I'm not a fudge!"
    a "Exactly! So in our eyes, you are the weird one here!"
    ...
    o "I'm Ophelie. Nice to meet you, Abigail!"
    a "You too Ophelie! So in our kingdom, there are many ethnic groups of fudges."
    a "I am from the mint fudge group--your favourite flavour!"
    hide glad
    ...
    a "So yes, peanut butter fudge is famous for its dense, melt-in-your-mouth texture, balancing sugary sweetness with nutty peanut butter flavor."
    o "Mmm... Yeah! I also know that they are often enhanced with vanilla and butter for depth, and can range from simple 4-ingredient versions to more complex recipes with chocolate or crunchy additions, providing a satisfying smooth, not gritty, treat perfect for gifting or snacking!"
    a "Oh yeah, perfect for gifting! You will get peanut butter fudge if you can answer this question."
    ...
    o "Ha! Easy peasy! You can make easy 4-ingredient peanut butter fudge using either a cooked sugar/milk method or a no-cook butter/sugar method."
    a "Oh you even know that! So, talk about the cooked sugar/milk method first! What are the 4 ingredients?"
    o "As the name suggests, sugar and milk are in it. The others are the crucial peanut butter and the fascinating vanilla!"
    ...
    show yes at smallleft with dissolve
    ...
    hide glad
    show confident at smallleft with dissolve
    o "Oh my god! Bring it on!"
    ...
    o "That's easy! Mint fudge is typically made with sugar, butter, milk/cream, chocolate/cocoa, and mint flavoring, like extract or candy."
    ...
    o "Mint fudge can be layered, swirled, loaded with Andes mints, or incorporate crushed Thin Mints cookies for added crunch."
